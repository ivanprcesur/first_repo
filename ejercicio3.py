...
while intentos  1
  ...
  if adivinar_intentos  longitud
    ...
    adivinar_intentos = int(input (la longitud que has seleccionado es menor ))
    lista.append(adivinar_intentos)

  if adivinar_intentos  longitud
    print (te quedan ,intentos, intentos)
    adivinar_intentos = int(input (la longitud que has seleccionado es mayor ))
    lista.append(adivinar_intentos)
...
elegir= int(input (elige entre 1letra o 2palabra ==  ))
...
def palabra()
  ...
  while intentos_restantes  1
    ...
    if palabra_introducida!=adivina_palabra
      ...
      adivina_palabra= input (la palabra introducida no es la correcta intentalo de nuevo )
